Locales['fr'] = {
  ...
  ['face'] = 'visage',
  ['skin'] = 'peau',
  ['nosew'] = 'Largeur du nez',
  ['nosel'] = 'Longueur du nez',
  ['noseh'] = 'Hauteur du nez',
  ['nosebh'] = 'Arete du nez',
  ['nosepl'] = 'Pointe du nez',
  ['noset'] = 'Epaisseur du nez',
  ['eyebh'] = 'Hauteur des sourcils',
  ['eyebf'] = 'Sourcils en avant',
  ['cbh'] = 'Hauteur des pommettes',
  ['cbw'] = 'Largeur des pommettes',
  ['chw'] = 'Largeur des joues',
  ['eyeop'] = 'Ouverture des yeux',
  ['lipst'] = 'Épaisseur des lèvres',
  ['jbw'] = 'Largeur de la mâchoire',
  ['jbbl'] = 'Longueur de la mâchoire',
  ['chbbl'] = 'Abaissement du menton',
  ['chbw'] = 'Longueur du menton',
  ['chbble'] = 'Largeur du menton',
  ['chho'] = 'Trou du menton',
  ['neckt'] = 'Largeur du cou',
  ['wrinkles'] = 'rides',
